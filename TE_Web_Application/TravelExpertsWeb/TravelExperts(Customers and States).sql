...
DECLARE @US_CountryId VARCHAR(10)
SET @US_CountryId = 'AMERICA'
DECLARE @CAD_CountryId VARCHAR(10)
SET @CAD_CountryId = 'CANADA'

INSERT INTO States (Id, Name, Abbreviation, CountryId) VALUES
 ...
 ALTER TABLE Customers ALTER COLUMN CustFirstName nvarchar(25) NULL;
 ALTER TABLE Customers ALTER COLUMN CustLastName nvarchar(25) NULL;
 ALTER TABLE Customers ALTER COLUMN CustAddress nvarchar(75) NULL;
 ALTER TABLE Customers ALTER COLUMN CustCity nvarchar(50) NULL;
 ALTER TABLE Customers ALTER COLUMN CustProv nvarchar(2) NULL;
 ALTER TABLE Customers ALTER COLUMN CustPostal nvarchar(7) NULL;
 ALTER TABLE Customers ALTER COLUMN CustCountry nvarchar(25) NULL;
 ALTER TABLE Customers ALTER COLUMN CustHomePhone nvarchar(20) NULL;
 ALTER TABLE Customers ALTER COLUMN CustBusPhone nvarchar(20) NULL;
 ALTER TABLE Customers ALTER COLUMN CustEmail nvarchar(50) not NULL;

 ALTER TABLE Customers
ALTER COLUMN CustProv nvarchar(20);
